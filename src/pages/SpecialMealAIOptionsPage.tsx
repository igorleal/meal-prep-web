...
export default function SpecialMealAIOptionsPage() {
  ...
  const handleSubmit = () => {
    ...
    const pendingRequestStr = sessionStorage.getItem('pendingSpecialMealRequest')
    ...
    const request = {
      ...
      eventDate: pendingData.eventDate,
