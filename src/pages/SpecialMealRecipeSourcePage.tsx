...
export default function SpecialMealRecipeSourcePage() {
  ...
  const handleSelectSource = (source: RecipeSourceType) => {
    if (source === 'ai') {
      navigate('/special-meals/source/ai')
    } else if (source === 'favorite') {
      navigate('/special-meals/source/favorites')
    } else if (source === 'loaded') {
      navigate('/special-meals/source/load')
    }
  }
      ...
      <div className="max-w-4xl mx-auto px-4 md:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-text-muted-light dark:text-text-muted-dark">
            {t('source.subtitle', 'How would you like to get recipes for your special meal?')}
          </p>
        </div>
